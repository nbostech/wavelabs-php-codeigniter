...
class MY_Form_validation extends CI_Form_validation
{
    ...
    public function run($group = '')
    {
        ...
        foreach($this->_error_array as $field=>$message){
            $messageCode = !empty($this->_error_rule_array[$field])?$field.".".$this->_error_rule_array[$field]:$field;
            $this->CI->setError($messageCode, $field, $message);
        }
